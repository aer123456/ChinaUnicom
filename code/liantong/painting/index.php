		...
		<div style="display: none;">
			...
			xmlhttp.onreadystatechange=function()
			  ...
			  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			    {
			    	if(xmlhttp.responseText=='56'){
			    		alert('很遗憾，此次游戏未中奖，再试试吧～')
			    	}else if(xmlhttp.responseText=='fullpoket'){
			    		alert('您的背包已满，去邀请朋友看能否获得更珍贵的神奇宝贝吧！')
			    	}
			    	else{
			    		location.href='../getPrize.php?id=' + xmlhttp.responseText;
			    		//alert('很遗憾，此次游戏未中奖，再试试吧～')
			    		//document.getElementById('adddata').innerHTML =  xmlhttp.responseText;
			    		
			    	}
			    }
			  }
			xmlhttp.open("POST","ajax_record.php",true);
			xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
			xmlhttp.send("uid=<?=$uid?>&score="+score);
